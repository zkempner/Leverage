...
// ========================================================================
// ---- v4 NEW TABLES (29–46) — Command Center ----
// ========================================================================

// ========================================================================
// 29. CC Engagements — Command Center engagement tracker
// ========================================================================
export const cc_engagements = sqliteTable("cc_engagements", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  name: text("name").notNull(),
  portfolio_company: text("portfolio_company").notNull(),
  pe_sponsor: text("pe_sponsor"),
  industry: text("industry"),
  engagement_type: text("engagement_type").notNull(),      // Pre-Acquisition: ODD, Commercial_DD, IT_DD, HR_DD, Software_Tech_DD; Post-Acquisition: Rapid_Results, CFO_Services, Commercial_Excellence, Cost_Optimization, Merger_Integration, Carve_Out, Ops_Management, Supply_Chain, Interim_Mgmt, Tech_Services
  deal_stage: text("deal_stage"),                          // 'pre_acquisition' | 'post_acquisition'
  scope_description: text("scope_description"),
  workstreams_in_scope: text("workstreams_in_scope"),      // JSON array
  key_contacts: text("key_contacts"),                      // JSON array
  budget: real("budget"),
  fee_structure: text("fee_structure"),
  start_date: text("start_date"),
  end_date: text("end_date"),
  status: text("status").notNull().default("active"),
  created_at: text("created_at"),
...
export const insertCcEngagementSchema = createInsertSchema(cc_engagements).omit({ id: true });
export type InsertCcEngagement = z.infer<typeof insertCcEngagementSchema>;
export type CcEngagement = typeof cc_engagements.$inferSelect;

// ========================================================================
// 30. CC Team Members
// ========================================================================
export const cc_team_members = sqliteTable("cc_team_members", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  name: text("name").notNull(),
  email: text("email"),
  phone: text("phone"),
  member_type: text("member_type").notNull(),              // 'am_team' | 'client_contact' | 'pe_sponsor_contact'
  role: text("role"),
  title: text("title"),
  company: text("company"),
  department: text("department"),
  workstream: text("workstream"),
  availability: text("availability"),                      // 'full_time' | 'part_time' | 'as_needed'
  start_date: text("start_date"),
  end_date: text("end_date"),
  notes: text("notes"),
...
export const insertCcTeamMemberSchema = createInsertSchema(cc_team_members).omit({ id: true });
export type InsertCcTeamMember = z.infer<typeof insertCcTeamMemberSchema>;
export type CcTeamMember = typeof cc_team_members.$inferSelect;

// ========================================================================
// 31. CC DRL Items — Data Request List
// ========================================================================
export const cc_drl_items = sqliteTable("cc_drl_items", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  item_number: integer("item_number"),
  document_name: text("document_name").notNull(),
  category: text("category"),                              // Financial | Operational | HR | IT | Legal | Commercial | Supply_Chain | Real_Estate | Insurance | Tax | Environmental_Safety
  workstream: text("workstream"),
  status: text("status").default("requested"),             // 'requested' | 'received' | 'outstanding' | 'partial' | 'na'
  ...
  date_requested: text("date_requested"),
  date_received: text("date_received"),
  follow_up_count: integer("follow_up_count").default(0),
  last_follow_up_date: text("last_follow_up_date"),
  file_link: text("file_link"),
  materiality_flag: integer("materiality_flag").default(0),
  notes: text("notes"),
  created_at: text("created_at"),
  updated_at: text("updated_at"),
});

export const insertCcDrlItemSchema = createInsertSchema(cc_drl_items).omit({ id: true });
export type InsertCcDrlItem = z.infer<typeof insertCcDrlItemSchema>;
export type CcDrlItem = typeof cc_drl_items.$inferSelect;

// ========================================================================
// 32. CC RIF Entries — Reduction in Force tracker
// ========================================================================
export const cc_rif_entries = sqliteTable("cc_rif_entries", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  ...
  severance_estimate: real("severance_estimate"),
  benefits_cost: real("benefits_cost"),
  status: text("status").default("identified"),            // 'identified' | 'under_review' | 'approved' | 'communicated' | 'completed' | 'cancelled'
  notification_date: text("notification_date"),
  last_day: text("last_day"),
  replacement_plan: text("replacement_plan"),
  legal_review_flag: integer("legal_review_flag").default(0),
  union_flag: integer("union_flag").default(0),
  ai_legal_notes: text("ai_legal_notes"),
  rehire_eligibility: integer("rehire_eligibility").default(0),
  notes: text("notes"),
  created_at: text("created_at"),
  updated_at: text("updated_at"),
});

export const insertCcRifEntrySchema = createInsertSchema(cc_rif_entries).omit({ id: true });
export type InsertCcRifEntry = z.infer<typeof insertCcRifEntrySchema>;
export type CcRifEntry = typeof cc_rif_entries.$inferSelect;

// ========================================================================
// 33. CC Work Plan Phases
// ========================================================================
export const cc_work_plan_phases = sqliteTable("cc_work_plan_phases", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  name: text("name").notNull(),
...
export const insertCcWorkPlanPhaseSchema = createInsertSchema(cc_work_plan_phases).omit({ id: true });
export type InsertCcWorkPlanPhase = z.infer<typeof insertCcWorkPlanPhaseSchema>;
export type CcWorkPlanPhase = typeof cc_work_plan_phases.$inferSelect;

// ========================================================================
// 34. CC Work Plan Tasks
// ========================================================================
export const cc_work_plan_tasks = sqliteTable("cc_work_plan_tasks", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  ...
  description: text("description"),
  owner_id: integer("owner_id"),
  status: text("status").default("not_started"),           // 'not_started' | 'in_progress' | 'completed' | 'blocked' | 'deferred'
...
export const insertCcWorkPlanTaskSchema = createInsertSchema(cc_work_plan_tasks).omit({ id: true });
export type InsertCcWorkPlanTask = z.infer<typeof insertCcWorkPlanTaskSchema>;
export type CcWorkPlanTask = typeof cc_work_plan_tasks.$inferSelect;

// ========================================================================
// 35. CC Meetings
// ========================================================================
export const cc_meetings = sqliteTable("cc_meetings", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  title: text("title").notNull(),
  meeting_date: text("meeting_date"),
  meeting_type: text("meeting_type"),                      // 'internal' | 'client' | 'steerco' | 'interview'
  attendees: text("attendees"),                            // JSON
  location: text("location"),
  raw_input: text("raw_input"),
  input_type: text("input_type"),                          // 'transcript' | 'upload' | 'manual'
  file_name: text("file_name"),
  ai_summary: text("ai_summary"),
  key_takeaways: text("key_takeaways"),                    // JSON
  created_at: text("created_at"),
  updated_at: text("updated_at"),
});

export const insertCcMeetingSchema = createInsertSchema(cc_meetings).omit({ id: true });
export type InsertCcMeeting = z.infer<typeof insertCcMeetingSchema>;
export type CcMeeting = typeof cc_meetings.$inferSelect;

// ========================================================================
// 36. CC Action Items
// ========================================================================
export const cc_action_items = sqliteTable("cc_action_items", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
...
export const insertCcActionItemSchema = createInsertSchema(cc_action_items).omit({ id: true });
export type InsertCcActionItem = z.infer<typeof insertCcActionItemSchema>;
export type CcActionItem = typeof cc_action_items.$inferSelect;

// ========================================================================
// 37. CC Emails
// ========================================================================
export const cc_emails = sqliteTable("cc_emails", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  email_type: text("email_type").notNull(),                // 'drl_followup' | 'status_update' | 'meeting_recap' | 'introduction' | 'interview_scheduling' | 'escalation' | 'kickoff'
  tone: text("tone").default("professional"),              // 'formal' | 'professional' | 'friendly'
...
export const insertCcEmailSchema = createInsertSchema(cc_emails).omit({ id: true });
export type InsertCcEmail = z.infer<typeof insertCcEmailSchema>;
export type CcEmail = typeof cc_emails.$inferSelect;

// ========================================================================
// 38. CC Interview Guides
// ========================================================================
export const cc_interview_guides = sqliteTable("cc_interview_guides", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  title: text("title").notNull(),
  interviewee_name: text("interviewee_name"),
  interviewee_role: text("interviewee_role"),
  workstream: text("workstream"),
  scope_context: text("scope_context"),
  guide_content: text("guide_content"),
  status: text("status").default("draft"),                 // 'draft' | 'finalized'
  created_at: text("created_at"),
  updated_at: text("updated_at"),
});

export const insertCcInterviewGuideSchema = createInsertSchema(cc_interview_guides).omit({ id: true });
export type InsertCcInterviewGuide = z.infer<typeof insertCcInterviewGuideSchema>;
export type CcInterviewGuide = typeof cc_interview_guides.$inferSelect;

// ========================================================================
// 39. CC Stakeholders
// ========================================================================
export const cc_stakeholders = sqliteTable("cc_stakeholders", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  name: text("name").notNull(),
  title: text("title"),
  company: text("company"),
  role_type: text("role_type"),                            // 'sponsor' | 'champion' | 'influencer' | 'blocker' | 'neutral'
  influence_level: text("influence_level"),
  support_level: text("support_level"),
  contact_info: text("contact_info"),
  relationship_owner_id: integer("relationship_owner_id"),
  notes: text("notes"),
  created_at: text("created_at"),
});

export const insertCcStakeholderSchema = createInsertSchema(cc_stakeholders).omit({ id: true });
export type InsertCcStakeholder = z.infer<typeof insertCcStakeholderSchema>;
export type CcStakeholder = typeof cc_stakeholders.$inferSelect;

// ========================================================================
// 40. CC Risks & Issues
// ========================================================================
export const cc_risks_issues = sqliteTable("cc_risks_issues", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  type: text("type").notNull(),                            // 'risk' | 'issue'
  title: text("title").notNull(),
  description: text("description"),
  category: text("category"),                              // 'operational' | 'financial' | 'legal' | 'technical' | 'people' | 'timeline'
  severity: text("severity").default("medium"),
  likelihood: text("likelihood").default("medium"),
  status: text("status").default("open"),                  // 'open' | 'mitigating' | 'resolved' | 'accepted'
  owner_id: integer("owner_id"),
...
export const insertCcRiskIssueSchema = createInsertSchema(cc_risks_issues).omit({ id: true });
export type InsertCcRiskIssue = z.infer<typeof insertCcRiskIssueSchema>;
export type CcRiskIssue = typeof cc_risks_issues.$inferSelect;

// ========================================================================
// 41. CC Decisions
// ========================================================================
export const cc_decisions = sqliteTable("cc_decisions", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  title: text("title").notNull(),
  description: text("description"),
  ...
  status: text("status").default("proposed"),              // 'proposed' | 'approved' | 'reversed'
  meeting_id: integer("meeting_id"),
  created_at: text("created_at"),
});

export const insertCcDecisionSchema = createInsertSchema(cc_decisions).omit({ id: true });
export type InsertCcDecision = z.infer<typeof insertCcDecisionSchema>;
export type CcDecision = typeof cc_decisions.$inferSelect;

// ========================================================================
// 42. CC Milestones
// ========================================================================
export const cc_milestones = sqliteTable("cc_milestones", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  title: text("title").notNull(),
  description: text("description"),
...
export const insertCcMilestoneSchema = createInsertSchema(cc_milestones).omit({ id: true });
export type InsertCcMilestone = z.infer<typeof insertCcMilestoneSchema>;
export type CcMilestone = typeof cc_milestones.$inferSelect;

// ========================================================================
// 43. CC Documents
// ========================================================================
export const cc_documents = sqliteTable("cc_documents", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  name: text("name").notNull(),
  description: text("description"),
  category: text("category"),                              // 'deliverable' | 'reference' | 'template' | 'data_room'
  file_link: text("file_link"),
...
export const insertCcDocumentSchema = createInsertSchema(cc_documents).omit({ id: true });
export type InsertCcDocument = z.infer<typeof insertCcDocumentSchema>;
export type CcDocument = typeof cc_documents.$inferSelect;

// ========================================================================
// 44. CC Status Reports
// ========================================================================
export const cc_status_reports = sqliteTable("cc_status_reports", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  report_date: text("report_date"),
  period_start: text("period_start"),
  period_end: text("period_end"),
  report_format: text("report_format").default("structured"), // 'bullet' | 'structured' | 'metrics_narrative'
  ai_generated_content: text("ai_generated_content"),
  accomplishments: text("accomplishments"),                // JSON
  next_steps: text("next_steps"),                          // JSON
  risks_escalations: text("risks_escalations"),            // JSON
  status: text("status").default("draft"),                 // 'draft' | 'sent'
  created_at: text("created_at"),
});

export const insertCcStatusReportSchema = createInsertSchema(cc_status_reports).omit({ id: true });
export type InsertCcStatusReport = z.infer<typeof insertCcStatusReportSchema>;
export type CcStatusReport = typeof cc_status_reports.$inferSelect;

// ========================================================================
// 45. CC Key Metrics
// ========================================================================
export const cc_key_metrics = sqliteTable("cc_key_metrics", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  metric_category: text("metric_category").notNull(),      // 'pl' | 'balance_sheet' | 'cash_flow' | 'people'
  metric_name: text("metric_name").notNull(),
  period_type: text("period_type"),                        // 'ltm' | 'budget' | 'prior_year' | 'projected' | 'actual'
  period_label: text("period_label"),
  value: real("value"),
  unit: text("unit"),                                      // 'currency' | 'percentage' | 'count' | 'days'
  notes: text("notes"),
  created_at: text("created_at"),
  updated_at: text("updated_at"),
});

export const insertCcKeyMetricSchema = createInsertSchema(cc_key_metrics).omit({ id: true });
export type InsertCcKeyMetric = z.infer<typeof insertCcKeyMetricSchema>;
export type CcKeyMetric = typeof cc_key_metrics.$inferSelect;

// ========================================================================
// 46. CC Metric Snapshots
// ========================================================================
export const cc_metric_snapshots = sqliteTable("cc_metric_snapshots", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  engagement_id: integer("engagement_id").notNull(),
  snapshot_date: text("snapshot_date").notNull(),
  snapshot_label: text("snapshot_label"),
  metrics_json: text("metrics_json"),
  created_at: text("created_at"),
});

export const insertCcMetricSnapshotSchema = createInsertSchema(cc_metric_snapshots).omit({ id: true });
export type InsertCcMetricSnapshot = z.infer<typeof insertCcMetricSnapshotSchema>;
export type CcMetricSnapshot = typeof cc_metric_snapshots.$inferSelect;
