...
if (currentVersion < 4) {
  sqlite.exec(`
    -- ================================================================
    -- v4 Migration: Pipeline orchestration tables. Non-destructive.
    -- ================================================================
    ...
    CREATE INDEX IF NOT EXISTS idx_pipeline_runs_engagement ON pipeline_runs(engagement_id);
    CREATE INDEX IF NOT EXISTS idx_pipeline_runs_status ON pipeline_runs(status);
    CREATE INDEX IF NOT EXISTS idx_pipeline_steps_run ON pipeline_steps(pipeline_run_id);
    CREATE INDEX IF NOT EXISTS idx_pipeline_steps_status ON pipeline_steps(pipeline_run_id, status);

    PRAGMA user_version = 4;
  `);

  console.log("Schema v4 applied: 2 new tables (pipeline_runs, pipeline_steps).");
}
